  ...
  return (
    <section className="relative mx-auto min-h-[92vh] sm:min-h-screen w-full overflow-hidden flex flex-col justify-between pt-[100px] sm:pt-[120px] pb-8">
      ...
      >
        ...
        <div className="mt-2 sm:mt-5 flex flex-col items-center justify-center relative select-none pointer-events-none">
          {/* Pulsing Beacon Dot */}
          <div className="relative flex items-center justify-center">
            <span className="animate-ping absolute inline-flex h-5 w-5 sm:h-7 sm:w-7 rounded-full bg-[#915EFF] opacity-75" />
            <div className="relative h-3.5 w-3.5 sm:h-5 sm:w-5 rounded-full bg-gradient-to-tr from-[#915EFF] to-[#00f2fe] shadow-[0_0_15px_#915eff]" />
          </div>

          {/* Vertical Line with Moving Light Packet */}
          <div className="violet-gradient relative h-36 w-1 sm:h-80 overflow-hidden rounded-full shadow-[0_0_12px_rgba(145,94,255,0.6)]">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <p className="text-secondary text-[13px] sm:text-[15px] mt-2 max-w-xl leading-relaxed">
          ...
          {isMobile && (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a
                  href="#projects"
                  className="bg-gradient-to-r from-[#915eff] to-[#703bf7] hover:from-[#804bee] hover:to-[#602ce6] text-white px-5 py-2.5 rounded-xl font-semibold text-sm shadow-lg shadow-purple-600/30 active:scale-95 transition-all inline-flex items-center gap-2"
                >
                ...
                <a
                  href="#contact"
                  className="bg-tertiary/90 hover:bg-tertiary text-white border border-white/10 px-5 py-2.5 rounded-xl font-medium text-sm active:scale-95 transition-all"
                >
                  Contact Me
                </a>
                <a
                  ...
                  className="bg-white/10 hover:bg-white/20 text-white border border-white/15 px-4 py-2.5 rounded-xl font-medium text-sm active:scale-95 transition-all inline-flex items-center gap-1.5 cursor-pointer"
                >
                  <span>Resume</span>
              ...
              <div className="mt-2 rounded-2xl bg-[#100d25]/90 border border-purple-500/20 p-4 shadow-xl backdrop-blur-md">
